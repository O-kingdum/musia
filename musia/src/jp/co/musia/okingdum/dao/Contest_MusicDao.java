...
public class Contest_MusicDao extends Dao{
	 ...
	 * 
	 * @param contest_Music Contest_MusicBeanオブジェクト
	 ...
	 * 
	 * @param array ArrayList<Object> Contest_MusicBean
	...
	public ArrayList<Object> selectContest_Music(ArrayList<Object> array) {
		...
		try
		{
			...
			while(rs.next())
			{
				retarr.add(new Contest_MusicBean(
						rs.getString("f_contest_id"),
						rs.getString("f_product_id"),
						rs.getString("f_contest_admin_id"),
						rs.getInt("f_contest_examination"),
						rs.getString("f_record_date")
						)
				);
			}
		}
